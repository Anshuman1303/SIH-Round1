...
export default function EditScreen() {
    ...
    const newItem = isInvoiceHour
        ? { description: "", hours: undefined, rate: undefined, amount: "" }
        : { description: "", amount: "" };
        ...
        <ScrollView>
            <View style={styles.container}>
                ...
                <DatePickerInput
                    ...
                    onChange={(value) =>
                        setInvoice({ ...invoice, invoiceDate: value })
                    }
                    mode="flat"
                />
                ...
                <View style={styles.addressContainer}>
                    <View style={styles.address}>
                        ...
                        <Input
                            ...
                            invoice={invoice}
                            setInvoice={setInvoice}
                            dataKey="billToAddressLine1"
                        />
                        <Input
                            label="Address Line 2"
                            invoice={invoice}
                            setInvoice={setInvoice}
                            dataKey="billToAddressLine2"
                        />
                        <Input
                            label="Phone"
                            invoice={invoice}
                    ...
                    <View style={styles.address}>
                        ...
                        <Input
                            ...
                            invoice={invoice}
                            setInvoice={setInvoice}
                            dataKey="fromAddressLine1"
                        />
                        <Input
                            label="Address Line 2"
                            invoice={invoice}
                            setInvoice={setInvoice}
                            dataKey="fromAddressLine2"
                        />
                        <Input
                            label="Phone"
                            invoice={invoice}
